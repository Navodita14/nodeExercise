...
const repo = require("../repository/resource.repo");
const getAllResource = async () => {
  return repo.getAllResource();
};
const createResource = async (resource_name, resource_type) => {
  return repo.createResource(resource_name, resource_type);
};
...
const updateResource = async (id, updates) => {
  ...
  return repo.updateResource(id, updates);
};
